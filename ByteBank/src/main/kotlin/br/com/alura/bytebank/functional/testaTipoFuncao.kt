...
fun testaFuncaoAnonimaMultiplos() {
...
fun testaFuncaoLambdaMultiplos() {
...
fun testaFuncaoAnonima() {    //utiliza-se quando quer ter certeza o que quer retornar, pois ela nao retorna a ultima instrucao e sim o return
